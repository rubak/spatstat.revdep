...
#'
#' This function is a wrapper around \code{\link[spatstat.geom]{ppp}} function and
...
#'   \code{\link[spatstat.geom]{ppp}} function. Read the help page of that function
...
#'   data into sf format and \code{\link[spatstat.geom]{ppp}} for the original
#'   spatstat function.
#' @export
#'
#' @examples
...
#'   spatstat.geom::plot.ppp(spatstat.geom::unmark(x_ppp))
#' }
#'
